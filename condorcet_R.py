...
df = pd.read_csv('./data/%s/Cancer_List/result/GCN_NI/sort_gene.txt' % cancerType, delimiter="\t", index_col=0)
# df = pd.read_csv('./data/%s/NCG_711/result/GCN_NI/sort_gene.txt' % cancerType, delimiter="\t", index_col=0)
...
gene_result.to_csv('./data/%s/Cancer_List/result/GCN_NI/condorcet_gene.txt' % cancerType, sep="\t")
# gene_result.to_csv('./data/%s/NCG_711/result/GCN_NI/condorcet_gene.txt' % cancerType, sep="\t")
